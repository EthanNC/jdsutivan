  ...
  return (
    ...
    <Header siteTitle={data.site.siteMetadata.title} />
      <div class="flex min-h-screen flex-col">
        ...
        <footer class="bg-black py-4 px-8">
        ...
        <div class="text-white font-bold flex items-center justify-center pb-2">
          ...
          <a href="https://www.instagram.com/jd_sutivan_construction/?hl=da"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-instagram"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg></a>
          ...
          <div class="border-t border-solid border-primary py-4">
          ...
          <div class="pt-4 text-white flex justify-center">
